            ...
            <div className='event-container'>
              ...
              <div>
                    <div onClick={eventHandler} className='event-btn'>
                     ...
                     <h4 style={{fontSize:'16px', paddingTop:'6px',paddingLeft:'10px'}}>From <span style={{color:'blueviolet', fontSize:'20px',paddingRight:'6px'}}>6500</span>৳</h4>
                     </div>
                     <div style={{display:'flex', margin:'0'}}>
                        <FcAlarmClock className='icon-clock'/>
                        <p style={{fontSize:'16px', paddingTop:'8px', paddingLeft:'10px'}}> 2 Days & 3 Night</p>
                     </div>
                    </div>
                </div>
              <div>
                    <div onClick={eventHandler} className='event-btn'>
                     ...
                     <div style={{display:'flex', paddingTop:'12px', margin:'0'}}>
                     <MdElectricBolt className='icon-electric'/> 
                     <h4 style={{fontSize:'16px', paddingTop:'6px',paddingLeft:'10px'}}>From <span style={{color:'blueviolet', fontSize:'20px',paddingRight:'6px'}}>4500</span>৳</h4>
                     </div>
                     <div style={{display:'flex', margin:'0'}}>
                        <FcAlarmClock className='icon-clock'/>
                        <p style={{fontSize:'16px', paddingTop:'8px', paddingLeft:'10px'}}> 2 Days & 3 Night</p>
