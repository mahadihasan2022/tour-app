    ...
    <div className="about">
      <div className=" about-container">
        <div className="aboutText-container">
          <h1>The Most</h1>
          <h2>Interesting Digital</h2>
          <h3>In The World.</h3>
        </div>
        <div className="aboutDetails-container">
          <p>
            Blandit semper ac mi montes neque nostra vivamus dictum ullamcorper
            phasellus. Gravida metus viverra massa netus tortor nullam pharetra.
            Nunc leo auctor congue mus convallis scelerisque maecenas
            condimentum dictum dolor.
          </p>
      ...
      <div className="aboutContainer">
        <div className="aboutCard-container">
          ...
          <div className="aboutCard-details">
            ...
            <p>Diam platea nisi proin taciti laoreet consequat curabitur</p>
            <div className="about-btn-info">
              <button onClick={handleOnclick}>Visit Now</button>
            </div>
          </div>
        </div>
        <div className="aboutCard-container">
          ...
          <div className="aboutCard-details">
            ...
            <div className="about-btn-info">
              <button
                onClick={HandleClickPrestigious}
                className="w-28 h-8 bg-pink-500 rounded-sm font-bold italic"
              >
                Visit Now
              </button>
            </div>
        ...
        <div className="aboutCard-container">
          ...
          <div className="aboutCard-details">
            ...
            <div className="about-btn-info">
              <button
                onClick={handleOnclickCommunity}
                className="w-28 h-8 bg-pink-500 rounded-sm font-bold italic"
              >
                Visit Now
              </button>
